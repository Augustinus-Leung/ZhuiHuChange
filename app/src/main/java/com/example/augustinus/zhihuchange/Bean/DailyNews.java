package com.example.augustinus.zhihuchange.Bean;
...
public final class DailyNews {
    ...
    public DailyNews(DailyNews dailyNews){
        ...
        for (String aQuestionUrl : questionUrlList){
            tempQuestionUrlList.add(aQuestionUrl);
        }
    ...
    public int hashCode(){return dailyTitle.hashCode();}
